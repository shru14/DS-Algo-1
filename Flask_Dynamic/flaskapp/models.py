...
class StudentCourseChoice(db.Model):
    ...
    fourth_course_choice = db.Column(db.String(50), nullable=True)
    fifth_course_choice = db.Column(db.String(50), nullable=True)
...
class SupervisorStudentRanking(db.Model):
    ...
    capacity = db.Column(db.Integer, nullable=True, default=1)  


    def __repr__(self):
        return f"SupervisorStudentRanking('{self.id}', '{self.course}', {self.first_student_choice}', '{self.second_student_choice}', '{self.third_student_choice}, '{self.fourth_student_choice}', '{self.fifth_student_choice}', 'Capacity='{self.capacity}')"
